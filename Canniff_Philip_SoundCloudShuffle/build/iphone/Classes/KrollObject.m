...
//@interface Canniff_Philip_SoundCloudShuffleObject : NSObject
//@end

@interface Canniff_Philip_SoundCloudShuffleObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Canniff_Philip_SoundCloudShuffleObject class]])
		{
			for (NSString *key in [[(Canniff_Philip_SoundCloudShuffleObject*)o modules] allKeys])
			{
