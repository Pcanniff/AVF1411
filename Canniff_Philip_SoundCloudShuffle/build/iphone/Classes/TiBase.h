...
// in simulator we redefine to format for Canniff_Philip_SoundCloudShuffle Developer console
...
{\
	NSString * exceptionName = [@"org.canniff_philip_soundcloudshuffle." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.canniff_philip_soundcloudshuffle";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UICanniff_Philip_SoundCloudShuffleNativeItemNone = -1, 
	UICanniff_Philip_SoundCloudShuffleNativeItemSpinner = -2,
	UICanniff_Philip_SoundCloudShuffleNativeItemProgressBar = -3,
	
	UICanniff_Philip_SoundCloudShuffleNativeItemSlider = -4,
	UICanniff_Philip_SoundCloudShuffleNativeItemSwitch = -5,
	UICanniff_Philip_SoundCloudShuffleNativeItemMultiButton = -6,
	UICanniff_Philip_SoundCloudShuffleNativeItemSegmented = -7,
	
	UICanniff_Philip_SoundCloudShuffleNativeItemTextView = -8,
	UICanniff_Philip_SoundCloudShuffleNativeItemTextField = -9,
	UICanniff_Philip_SoundCloudShuffleNativeItemSearchBar = -10,
	
	UICanniff_Philip_SoundCloudShuffleNativeItemPicker = -11,
	UICanniff_Philip_SoundCloudShuffleNativeItemDatePicker = -12,
	
	UICanniff_Philip_SoundCloudShuffleNativeItemInfoLight = -13,
	UICanniff_Philip_SoundCloudShuffleNativeItemInfoDark = -14,
	
	UICanniff_Philip_SoundCloudShuffleNativeItemDisclosure = -15,
	
	UICanniff_Philip_SoundCloudShuffleNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Canniff_Philip_SoundCloudShuffle instances of
