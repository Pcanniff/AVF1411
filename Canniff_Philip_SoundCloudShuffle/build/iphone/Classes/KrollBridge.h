...
@interface Canniff_Philip_SoundCloudShuffleObject : KrollCoverageObject {
#else
@interface Canniff_Philip_SoundCloudShuffleObject : KrollObject {
#endif
@private
...
extern NSString * Canniff_Philip_SoundCloudShuffle$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Canniff_Philip_SoundCloudShuffleObject *_canniff_philip_soundcloudshuffle;
    KrollObject* console;
	BOOL shutdown;
