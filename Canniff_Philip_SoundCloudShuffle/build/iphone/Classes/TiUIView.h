...
/**
 Base class for all Canniff_Philip_SoundCloudShuffle views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Canniff_Philip_SoundCloudShuffle view hierarchy (such as wrapped iOS UIViews) was touched.
