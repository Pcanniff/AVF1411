...
//@interface Canniff_Philip_Project1_1411Object : NSObject
//@end

@interface Canniff_Philip_Project1_1411Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Canniff_Philip_Project1_1411Object class]])
		{
			for (NSString *key in [[(Canniff_Philip_Project1_1411Object*)o modules] allKeys])
			{
