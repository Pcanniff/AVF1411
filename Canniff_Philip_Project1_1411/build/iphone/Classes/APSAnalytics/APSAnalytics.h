 ...
 * to send analytic data that can be viewed on the Canniff_Philip_Project1_1411 Dashboard.
 *
 * For information on getting started with Canniff_Philip_Project1_1411 Platform Services,
