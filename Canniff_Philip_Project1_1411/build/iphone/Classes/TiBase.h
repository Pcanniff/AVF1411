...
// in simulator we redefine to format for Canniff_Philip_Project1_1411 Developer console
...
{\
	NSString * exceptionName = [@"org.canniff_philip_project1_1411." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.canniff_philip_project1_1411";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UICanniff_Philip_Project1_1411NativeItemNone = -1, 
	UICanniff_Philip_Project1_1411NativeItemSpinner = -2,
	UICanniff_Philip_Project1_1411NativeItemProgressBar = -3,
	
	UICanniff_Philip_Project1_1411NativeItemSlider = -4,
	UICanniff_Philip_Project1_1411NativeItemSwitch = -5,
	UICanniff_Philip_Project1_1411NativeItemMultiButton = -6,
	UICanniff_Philip_Project1_1411NativeItemSegmented = -7,
	
	UICanniff_Philip_Project1_1411NativeItemTextView = -8,
	UICanniff_Philip_Project1_1411NativeItemTextField = -9,
	UICanniff_Philip_Project1_1411NativeItemSearchBar = -10,
	
	UICanniff_Philip_Project1_1411NativeItemPicker = -11,
	UICanniff_Philip_Project1_1411NativeItemDatePicker = -12,
	
	UICanniff_Philip_Project1_1411NativeItemInfoLight = -13,
	UICanniff_Philip_Project1_1411NativeItemInfoDark = -14,
	
	UICanniff_Philip_Project1_1411NativeItemDisclosure = -15,
	
	UICanniff_Philip_Project1_1411NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Canniff_Philip_Project1_1411 instances of
