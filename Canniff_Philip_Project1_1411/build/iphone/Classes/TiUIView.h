...
/**
 Base class for all Canniff_Philip_Project1_1411 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Canniff_Philip_Project1_1411 view hierarchy (such as wrapped iOS UIViews) was touched.
