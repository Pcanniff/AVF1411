...
// in simulator we redefine to format for KDTest Developer console
...
{\
	NSString * exceptionName = [@"org.kdtest." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.kdtest";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIKDTestNativeItemNone = -1, 
	UIKDTestNativeItemSpinner = -2,
	UIKDTestNativeItemProgressBar = -3,
	
	UIKDTestNativeItemSlider = -4,
	UIKDTestNativeItemSwitch = -5,
	UIKDTestNativeItemMultiButton = -6,
	UIKDTestNativeItemSegmented = -7,
	
	UIKDTestNativeItemTextView = -8,
	UIKDTestNativeItemTextField = -9,
	UIKDTestNativeItemSearchBar = -10,
	
	UIKDTestNativeItemPicker = -11,
	UIKDTestNativeItemDatePicker = -12,
	
	UIKDTestNativeItemInfoLight = -13,
	UIKDTestNativeItemInfoDark = -14,
	
	UIKDTestNativeItemDisclosure = -15,
	
	UIKDTestNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all KDTest instances of
